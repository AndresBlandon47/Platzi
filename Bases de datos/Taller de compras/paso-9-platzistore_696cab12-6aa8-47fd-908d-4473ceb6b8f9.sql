...
(
   ...
   CLIENTE_FECHANAC     timestamp not null,
...
(
   ...
   PROV_CODCC           varchar(15) not null, 
   ITEM_ID              int not null,
...
(
   PROV_ID              numeric(5,0) not null,
   PROV_CODCC           varchar(15) not null comment 'Codigo de camara de comercio',
...
alter table ITEM_PROVEEDOR add constraint FK_ITEM_PROVEEDOR foreign key (PROV_ID, PROV_CODCC)
      references PROVEEDOR (PROV_ID, PROV_CODCC);
